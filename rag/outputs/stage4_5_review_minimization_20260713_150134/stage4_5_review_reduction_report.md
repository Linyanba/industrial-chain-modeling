...
- 阶段 4 输出路径：`D:\产业链建模\rag\outputs\stage4_normalization_20260713_150126`
- 原始人工复核项数量：**52**
- P0=5, P1=3, P2=0, P3=44
...
- [P0] 关系候选待复核: 新型显示产业->SUPPLIES_TO->产业链协同
- [P0] 关系候选待复核: 产业链->SUPPLIES_TO->创新链
- [P1] 关系候选待复核: 关键原材料->INPUT_TO->显示面板企业
- [P0] 关系候选待复核: 产业链->INPUT_TO->上下游
- [P1] 关系候选待复核: 材料->INPUT_TO->工艺
- [P0] 关系候选待复核: 供应链->OUTPUT_OF->显示产业
- [P0] 关系候选待复核: 创新链->INPUT_TO->产业链
