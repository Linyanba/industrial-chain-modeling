...
## L3_industry_link (6 个实体)

- **OSAT** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **半导体价值链** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **半导体设计制造** [industry_link] (value_chain=midstream, degree=0, confidence=medium)
- **封测** [industry_link] (value_chain=unknown, degree=0, confidence=high)
...
- **AI推理芯片** [technology] (value_chain=supporting, degree=0, confidence=medium)
...
- **封装测试** [process] (value_chain=midstream, degree=0, confidence=medium)
...
- **智能化** [application] (value_chain=downstream, degree=0, confidence=medium)
...
- **电动车** [application] (value_chain=downstream, degree=0, confidence=medium)
- **硅片** [material] (value_chain=upstream, degree=0, confidence=medium)
- **离子注入** [process] (value_chain=midstream, degree=1, confidence=medium)
- **网联化** [application] (value_chain=downstream, degree=0, confidence=medium)
