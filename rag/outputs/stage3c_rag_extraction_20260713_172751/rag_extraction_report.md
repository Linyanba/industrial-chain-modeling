...
| t08 | [10, 22] | 12 | 12 | 10 | 9 |
| t09 | [6, 10, 23] | 15 | 12 | 15 | 0 |
| t10 | [5, 6, 10, 22, 23] | 0 | 0 | 0 | 0 |

## 数量汇总

- 候选实体总数 / verified: 93 / 81
- 候选关系总数 / verified: 81 / 9
- 被拒绝候选: 63
- 复核队列项: 84
...
- relation_type_invalid: 16
- entity_type_invalid: 12
- relation_endpoint_type_mismatch: 10
- quote_not_found: 10
- evidence_id_not_in_context: 7
- relation_cue_missing: 6
...
- PASS entity_candidates_generated: 93 个
- PASS relation_candidates_generated: 81 个
- PASS verified_entities_generated: 81 个
- PASS verified_relations_generated: 9 个
- PASS json_outputs_valid_or_reviewed: 失败 0
- PASS all_verified_entities_have_evidence: 81 个 verified 实体
- PASS all_verified_relations_have_evidence: 9 个 verified 关系
- PASS verified_quotes_match_source_text: 90 个 verified 候选已通过原文校验
