...
- **显示材料产业** [sub_chain] (value_chain=cross_stage, degree=0, confidence=medium)

## L3_industry_link (8 个实体)
...
- **产业链** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **产业链上下游** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **供应链** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **物流** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **营销** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
- **采购** [industry_link] (value_chain=unknown, degree=0, confidence=medium)
...
- **OLED 材料** [material] (value_chain=upstream, degree=0, confidence=high)
...
- **光刻胶** [material] (value_chain=upstream, degree=0, confidence=medium)
...
- **加工** [process] (value_chain=midstream, degree=0, confidence=medium)
- **可穿戴设备** [application] (value_chain=downstream, degree=0, confidence=medium)
- **彩色滤光片** [material] (value_chain=upstream, degree=0, confidence=medium)
...
- **显示器件** [product] (value_chain=unknown, degree=0, confidence=medium)
- **显示材料** [material] (value_chain=upstream, degree=0, confidence=high)
- **显示芯片** [material] (value_chain=upstream, degree=0, confidence=high)
...
- **靶材** [material] (value_chain=upstream, degree=0, confidence=high)
...
- **产业集群** [region] (value_chain=supporting, degree=0, confidence=medium)
- **财关税政策** [policy] (value_chain=supporting, degree=0, confidence=medium)
