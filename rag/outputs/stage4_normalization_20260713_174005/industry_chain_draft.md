...
- **封装测试** [industry_link] (value_chain=midstream, degree=0, confidence=medium)
...
- **刻蚀** [process] (value_chain=midstream, degree=0, confidence=medium)
...
- **晶圆制造** [process] (value_chain=midstream, degree=3, confidence=medium)
