...
- 阶段 4 输出路径：`D:\产业链建模\rag\outputs\stage4_normalization_20260715_145553`
- 原始人工复核项数量：**89**
- P0=0, P1=19, P2=0, P3=70
...
- [P1] 关系候选待复核: 封装->OUTPUT_OF->芯片
- [P1] 关系候选待复核: 测试->OUTPUT_OF->芯片
- [P1] 关系候选待复核: 封测->OUTPUT_OF->芯片
