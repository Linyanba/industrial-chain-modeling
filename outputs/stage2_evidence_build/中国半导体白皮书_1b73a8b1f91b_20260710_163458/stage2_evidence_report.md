...
- 页面总数：25
- parsed_run：D:\产业链建模\parsed_documents\中国半导体白皮书_1b73a8b1f91b
- 日志：D:\产业链建模\logs\stage2_build_evidence_20260710_163458.log
...
- 第9、14页产业链图仅作为待复核视觉证据，未识别节点、箭头、上下游关系或产业层级。

## 7. 第25页处理

- 第25页为二维码/品牌尾页；本阶段仅保留页面级元信息，未执行OCR，未纳入正文证据主流程。
...
- 第9、14页产业链图仅作为待复核视觉证据，不可直接作为关系事实写入图谱。
